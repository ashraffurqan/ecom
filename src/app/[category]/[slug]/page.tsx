  ...
  return (
    <div><section className="text-gray-600 body-font overflow-hidden">
         ...
         {/* image */}
          ...
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            ...
            <p className="leading-relaxed scroll-m-20 text-base font-normal text-myPink">
              Best Quality Cotton Fabric Tops for Women<br></br>
            ...
            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
              <div className="flex">
                ...
                <button className="border-2 border-gray-300 mr-1 bg-white rounded-full w-6 h-6 focus:outline-none
              active:border-black focus:border-black" />
                <button className="border-2 border-gray-300 mr-1 bg-red-600 rounded-full w-6 h-6 focus:outline-none
              active:border-black focus:border-black" />
                <button className="border-2 border-gray-300 mr-1 bg-blue-600 rounded-full w-6 h-6 focus:outline-none
              active:border-black focus:border-black" />
                <button className="border-2 border-gray-300 mr-1 bg-orange-500 rounded-full w-6 h-6 focus:outline-none
              active:border-black focus:border-black" />
     ...
     mt-2 scroll-m-20  text-base font-semibold rounded-xl tracking-tight transition-colors h-fit w-fit  '>
              ...
              <div className='mr-2 ml-2 scroll-m-20 text-base font-semibold tracking-tight'>1
